...
namespace ORB_SLAM3 {
    ...
    bool KannalaBrandt8::ReconstructWithTwoViews(const cuda::managed::ManagedVector<KeyPoint>::SharedPtr vKeys1, const cuda::managed::ManagedVector<KeyPoint>::SharedPtr vKeys2, const std::vector<int> &vMatches12,
        ...
        for(size_t i = 0; i < vKeys1->size(); i++) vPts1[i] = vKeys1->getHostPtr()[i].pt;
        for(size_t i = 0; i < vKeys2->size(); i++) vPts2[i] = vKeys2->getHostPtr()[i].pt;
        ...
        for(size_t i = 0; i < vKeys1->size(); i++) vKeysUn1->getHostPtr()[i].pt = vPts1[i];
        for(size_t i = 0; i < vKeys2->size(); i++) vKeysUn2->getHostPtr()[i].pt = vPts2[i];
