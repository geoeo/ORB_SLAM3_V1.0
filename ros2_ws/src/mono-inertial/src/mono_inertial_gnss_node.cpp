...
// F6
      ...
      auto sub_gnss_options = rclcpp::SubscriptionOptions();
      ...
      sub_gnss_filter.subscribe(this, "/AIT_Fighter4/mavros/global_position/global", rclcpp::SensorDataQoS().keep_last(1000).get_rmw_qos_profile(), sub_gnss_options);
